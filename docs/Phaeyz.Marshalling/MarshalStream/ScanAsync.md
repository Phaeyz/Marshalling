# MarshalStream.ScanAsync method (1 of 3)

Efficiently reads each byte of a stream until a scanning function instructs to stop reading.

```csharp
public ValueTask<MarshalStreamScanResult> ScanAsync(int minBytesNeededForScan, long maxBytesToRead, 
    Func<ReadOnlyMemory<byte>, int> scanFunc, CancellationToken cancellationToken = default)
```
...
A task yielding a [`MarshalStreamScanResult`](../MarshalStreamScanResult.md) object.
...
# MarshalStream.ScanAsync method (2 of 3)

Efficiently reads each byte of a stream until a scanning function instructs to stop reading.

```csharp
public ValueTask<MarshalStreamScanResult> ScanAsync(Memory<byte> destinationBuffer, 
    int minBytesNeededForScan, Func<ReadOnlyMemory<byte>, int> scanFunc, 
...
# MarshalStream.ScanAsync method (3 of 3)

Efficiently reads each byte of a stream until a scanning function instructs to stop reading.

```csharp
public ValueTask<MarshalStreamScanResult> ScanAsync(Stream destinationStream, 
    int minBytesNeededForScan, long maxBytesToRead, Func<ReadOnlyMemory<byte>, int> scanFunc, 
    CancellationToken cancellationToken = default)
```
